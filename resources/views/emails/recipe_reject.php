                        ...
                        <tr>
                            <td class="sm-py-32 sm-px-24"
                                style="mso-line-height-rule: exactly; padding: 48px; text-align: center; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                 <a href="http://Project-name.com/" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
      <img src="{{ asset('logo.png') }}" width="155" alt="Project-name " style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0;">
    </a>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Your recipe has been approved by admin. Please click on link below to proceed further.
                                            ...
                                            <table cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td
                                                        ...
                                                        <a href="{{$url}}"
                                                            style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">View Recipe &rarr;</a>
                                                    </td>
                                                </tr>
                                            </table>
